					...
					<div style={aboutContainer}>
						...
						<div style={rowStyle} className="row">
							<div className="col-xs-12">
								...
								<h4 style={paragraphStyles}>You can check out some of my latest github commits <a href="https://github.com/blaynem/" target="_blank" rel="noopener noreferrer">here</a></h4>
							</div>
						</div>
						<div style={rowStyle} className="row">
